export const dict = {
  ...
  "help.tabs.worktrees": "The new design does not support Git Worktrees yet, it's coming soon. So if you'd prefer to continue using the previous layout, you can switch between layouts in Settings. Just keep in mind that the new layout will become permanent in a few weeks.",
  "file.manager.newFile": "New file",
  "file.manager.newFolder": "New folder",
  "file.manager.upload": "Upload",
  "file.manager.refresh": "Refresh",
  "file.manager.rename": "Rename",
  "file.manager.delete": "Delete",
  "file.manager.download": "Download",
  "file.manager.create": "Create",
  "file.manager.name": "Name",
  "file.manager.uploading": "Uploading {{done}}/{{total}}",
  "file.manager.uploaded": "Upload complete",
  "file.manager.uploadFailed": "Uploads failed: {{count}}",
  "file.manager.uploadWarning": "{{count}} file(s) larger than 100 MB. Upload anyway?",
  "file.confirm.delete.title": "Delete {{name}}?",
  "file.confirm.delete.description": "This action cannot be undone.",
  "file.confirm.typeName": "Type {{name}} to confirm",
  "file.ops.failed": "File operation failed",
  "settings.general.row.releaseNotes.description": "Show What's New popups after updates",
  "file.menu.copy": "Copy",
  "file.menu.move": "Move",
  "file.menu.compress": "Compress to ZIP",
  "file.menu.extract": "Extract here",
  "file.tree.root": "Project root",
  "file.tree.hidden.show": "Show hidden files",
  "file.tree.hidden.hide": "Hide hidden files",
  "file.tree.expandAll": "Expand all",
  "file.tree.collapseAll": "Collapse all",
  "file.breadcrumb.aria": "Current directory",
  "file.toolbar.aria": "File actions",
}
